...
/**
 * Determines whether a student can register for a standard course.
 *
 * This version intentionally does not use inheritance or abstraction.
 * All registration logic is implemented directly in this class.
 */
public class StandardRegistrationPolicy {
     ...
     *       completed all prerequisites, and the student has enough credit hours
     */
